...
export default function GRNList() {
  ...
  const fetchRows = async () => {
    try {
      ...
      console.error(e);
      setError(e?.message || 'Failed to load GRNs');
    } finally {
      setLoading(false);
    }
  };
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter((r) => {
      ...
      return (
        ...
        String(linked.poNo || '').toLowerCase().includes(q) ||
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg font-bold text-gray-900">Goods Received Notes (GRN)</h1>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600">GRN</th>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">
                          <div className="flex flex-col gap-1">
                            <div>
                              ...
                              <span className="font-medium">{linked.poNo || (linked.poId ? 'Linked' : '—')}</span>
                            </div>
                            <div>
